...
public class EmployeeController {
    ...
    public String showList(@RequestParam(name = "skillId", required = false) Long skillId, @RequestParam(name = "yearsOfService", required = false) Integer yearsOfService, Model model) {
    ...
    public String create(@RequestParam(name = "name") String name,
                         ...
                         @RequestParam(name = "type") EmployeeType type,
                         @RequestParam(name = "skillId") List<Long> skillId,
                         @RequestParam(name = "employmentDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate employmentDate) {
